...
def get_model_type(cfg: DictConfig | dict) -> VelocityModule | MLPVelocityModule:
    """Get the model type from a config."""
    model_class = cfg["velocity_model"]["_target_"]
    match model_class:
        case "fmfourier.models.velocity_models.VelocityModule":
            return VelocityModule
        case "fmfourier.models.velocity_models.MLPVelocityModule":
            return MLPVelocityModule
        case "fmfourier.models.velocity_models.LSTMVelocityModule":
            return LSTMVelocityModule
        case _:
